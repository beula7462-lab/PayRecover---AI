      ...
      >
        <div>
          ...
          <div className="p-6 border-b border-slate-800/60 flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-yellow-500 via-amber-400 to-yellow-300 flex items-center justify-center shadow-lg shadow-yellow-500/25">
              <Zap className="w-5 h-5 text-slate-950 fill-slate-950" />
            </div>
            <div>
              <h1 className="font-bold text-lg text-white tracking-tight leading-none flex items-center gap-1.5">
                PayRecover <span className="text-yellow-400 font-extrabold">AI</span>
              </h1>
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ? "bg-yellow-500/15 text-yellow-300 border border-yellow-500/40 shadow-sm"
                      : "text-slate-400 hover:text-white hover:bg-slate-900/60 hover:border hover:border-slate-800/50"
                  )}
                >
                  ...
                  {item.badge && (
                    <span className="text-[10px] uppercase font-bold px-2 py-0.5 rounded-full bg-yellow-500/20 text-yellow-300 border border-yellow-500/40">
                      {item.badge}
                    </span>
                  )}
                </Link>

...
export default function PaymentsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="fintech-card p-5 rounded-2xl border space-y-4">
      ...
      {/* Transaction Table */}
      <div className="fintech-card rounded-2xl border overflow-hidden">
          ...
          <table className="w-full text-left text-xs">
            <thead className="bg-slate-900/80 text-slate-400 font-semibold uppercase tracking-wider border-b border-slate-800">
              <tr>
                ...
                <th className="p-4 cursor-pointer hover:text-white" onClick={() => handleSort("amount")}>
                ...
                <th className="p-4 cursor-pointer hover:text-white" onClick={() => handleSort("transaction_date")}>
                  <div className="flex items-center gap-1">
                    <span>Date</span>
                    <ArrowUpDown className="w-3 h-3 text-slate-500" />
                  </div>
                </th>
                <th className="p-4 cursor-pointer hover:text-white" onClick={() => handleSort("recovery_probability")}>
                  <div className="flex items-center gap-1">
              ...
              {loading ? (
                ...
                <tr>
                  <td colSpan={10} className="p-12 text-center text-slate-400">
                    ...
                    <p className="font-semibold text-slate-300">No failed payments found.</p>
        ...
        {data && data.total_pages > 1 && (
          <div className="p-4 bg-slate-900/60 border-t border-slate-800 flex items-center justify-between text-xs text-slate-400">
            <span>
              Showing Page <strong className="text-white">{data.page}</strong> of <strong className="text-white">{data.total_pages}</strong> ({data.total} Total)
            </span>
